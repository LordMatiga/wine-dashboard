    ...
    <div className="bg-zinc-50 rounded-xl border border-zinc-200 shadow-sm p-4 flex flex-col gap-3">
      <div className="flex flex-col sm:flex-row gap-3">
        <input
          ...
          className="flex-1 px-3 py-2 text-sm rounded-lg border border-zinc-200 focus:outline-none focus:ring-2 focus:ring-[#2d4a6b]/20 focus:border-[#2d4a6b] placeholder-zinc-400"
        />
